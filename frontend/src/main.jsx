...
import AdditionalOrders from "./pages/AdditionalOrders.jsx";
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          {showAdminNav && (
            <nav className="flex items-center gap-4">
              ...
              <Link to="/admin/additional-orders" className="hover:underline">
                추가 신청자 관리
              </Link>
            </nav>
          )}
  ...
  <React.StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/additional-orders" element={<Frame><AdditionalOrders /></Frame>} />
        ...
        <Route path="/student/history" element={<Frame><StudentHistory /></Frame>} />
      </Routes>
    </BrowserRouter>
  </React.StrictMode>
);
